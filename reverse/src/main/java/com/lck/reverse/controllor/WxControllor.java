...
//        params.put("pageSize", 6);
    ...
    public ResultMessage getNews(
        ...
        List<TNews> collect = tNewsService.list().stream().sorted((o1, o2) -> o2.getId().compareTo(o1.getId())).collect(Collectors.toList());
    ...
    public ResultMessage getNewsIndex(
        ...
        if (list.size() > 2) {
            list = list.stream().sorted((o1, o2) -> o2.getId().compareTo(o1.getId())).skip(0).limit(2).collect(Collectors.toList());
        }
