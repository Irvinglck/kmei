...
public class PDFAddImage2 {

    private static final Logger logger = LoggerFactory.getLogger(PDFAddImage2.class);


    public static void main(String[] args) {
        generatePDF("F:\\d.pdf","F:\\g.pdf","F:\\dog.jpg");
    }
...
//                image.setAbsolutePosition(0, pa.getAsNumber(pa.size() - 1).floatValue());
                image.setAbsolutePosition(420,20);
                //设置插入的图片大小
